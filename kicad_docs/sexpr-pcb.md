...
* [General Section](#_general_section)
* [Page Section](#_page_section)
* [Layers Section](#_layers_section)
* [Setup Section](#_setup_section)
  + [Stack Up Settings](#_stack_up_settings)
  + [Stack Up Layer Settings](#_stack_up_layer_settings)
  + [Plot Settings](#_plot_settings)
* [Property Section](#_property_section)
* [Nets Section](#_nets_section)
* [Footprint Section](#_footprint_section)
* [Graphic Items Section](#_graphic_items_section)
* [Images Section](#_images_section)
* [Tracks Section](#_tracks_section)
  + [Track Segment](#_track_segment)
  + [Track Via](#_track_via)
  + [Track Arc](#_track_arc)
* [Zones Section](#_zones_section)
* [Group Section](#_group_section)
* [Board Example:](#_board_example)
...
See the [page settings definition](../sexpr-intro/index.html#_page_settings) in the common
...
| **2** | The [`CANONICAL_NAME`](#_canonical_layer_names) is the layer name defined for internal board use. |
...
|  |  |
| --- | --- |
| **1** | The optional [`STACK_UP_SETTINGS`](#_stack_up_settings) define the parameters required to manufacture the board. |
...
| **8** | The [`PLOT_SETTINGS`](#_plot_settings) define how the board was last plotted. |
...
|  |  |
| --- | --- |
| **1** | The layer stack up definitions is a list of layer [settings for each layer](#_stack_up_layer_settings) required to manufacture a board including the dielectric material between the actual layers defined in the board editor. |
...
|  |  |
| --- | --- |
| **1** | The layer name attribute is either one of the [canonical copper or technical layer names](#_canonical_layer_names) listed in the table above or `dielectric ID` if it is dielectric layer. |
...
and is defined in the [set up section](#_setup_section).
...
| **27** | The `outputformat` token defines the last plot type. * 0 - gerber * 1 - PostScript * 2 - SVG * 3 - DXF * 4 - HPGL * 5 - PDF |
...
See the [properity definition](../sexpr-intro/index.html#_properties) in the s-expression
...
See the [Graphic Items](../sexpr-intro/index.html#_graphic_items) section in the s-expression
board common definitions. This section will not exist if there are no graphics on the board.

## Images Section

See the [Images](../sexpr-intro/index.html#_images) section in the s-expression
board common definitions. This section will not exist if there are no images on the board.

## Tracks Section

This section lists all of [segment](#_track_segment_syntax), [via](#_track_via_syntax), and
[arc](#_track_arc_syntax) objects that make up tracks on the board.
...
| **4** | The `layer` token defines the [canonical layer](#_canonical_layer_names) the track segment resides on. |
| **5** | The optional `locked` token defines if the line cannot be edited. |
| **6** | The `net` token defines by the net ordinal number which net in the [net section](#_net_section) that the segment is part of. |
...
| **6** | The `layers` token attributes define the [canonical layer set](#_canonical_layer_names) the via connects. |
...
| **10** | The `net` token attribute defines by net ordinal number which net in the [net section](#_net_section) that the segment is part of. |
...
| **5** | The `layer` token defines the [canonical layer](#_canonical_layer_names) the track arc resides on. |
| **6** | The optional `locked` token defines if the line cannot be edited. |
| **7** | The `net` token defines by the net ordinal number which net in the [net section](#_net_section) that the segment is part of. |
| **8** | The `tstamp` token defines the unique identifier of the line object. |

## Zones Section

See the [zone definition](../sexpr-intro/index.doc#_zone) in the s-expression board common
definitions. This section will not exist if there are no zones on the board.

## Group Section

See the [group definition](../sexpr-intro/index.doc#_group) in the s-expression board common
