...
SYMATTR Value MAX14662
SYMATTR Prefix X
SYMATTR SpiceModel MAX14662.sub
SYMATTR Value2 MAX14662
SYMATTR Description Beyond-the-Rails SPST (Switch shown for a logic 0 input)
PIN -96 16 NONE 8
PINATTR PinName IN
