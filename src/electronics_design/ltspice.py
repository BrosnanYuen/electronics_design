...
get_wires_startpos_endpos = _pathtracing.get_wires_startpos_endpos  # Re-export the start/end position helper.
...
__all__ = [  # Publish the stable public API surface through the legacy wrapper.
    ...
    "get_wires_startpos_endpos",  # Export the start/end position helper.
